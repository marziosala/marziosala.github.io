...
```
    ...
    <OrderEnforcing<PassiveEnvChecker<AtariEnv<ALE/Tetris-v5>>>>
...
Not all the images have the same resolution, yet most of them are $210 \times 160$; those that arens't are resized.
