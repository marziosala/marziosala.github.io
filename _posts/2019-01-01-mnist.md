...
Back-Propagation Networ](http://yann.lecun.com/exdb/publis/pdf/lecun-90c.pdf) paper also describes nicely the engineering tasks needed to generate such data.
