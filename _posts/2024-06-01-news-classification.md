...
```
    ...
    prompt tokens: 4474, completion tokens: 999  (198.25 tokens/s)
...
```
    ...
    ⇒ Business and Economy (60%) International News (40%) 
    ...
    ⇒ International News (60%) Politics (40%) 
    ...
    ⇒ Weather (70%) International News (30%) 
    ...
    ⇒ Arts and Culture (60% ⚠) Human Interest (40%) 
    ...
    ⇒ Religion (60%) International News (40%) 
    ...
    ⇒ Social Issues (70%) International News (30%) 
    ...
    ⇒ International News (70%) War and Conflicts (30%) 
    ...
    ⇒ Business and Economy (60%) Crime and Law (40%) 
    ...
    ⇒ Environment (60%) Science and Technology (40%) 
    ...
    ⇒ Crime and Law (60%) Science and Technology (40%) 
    ...
    ⇒ International News (70%) Crime and Law (30%) 
    ...
    ⇒ Crime and Law (70%) Human Interest (30%) 
